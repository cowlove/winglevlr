...
winglevlr_ubuntu:	winglevlr.ino ESP32sim_ubuntu.h WaypointNav.h RollAHRS.h PidControl.h GDL90Parser.h ${HOME}/Arduino/libraries/esp32jimlib/src/jimlib.h 
	g++  -x c++ -g $< -o $@ -DAHRS_RATE=${AHRS_RATE} -DESP32 -DUBUNTU -I./ -I${HOME}/Arduino/libraries/TinyGPSPlus-1.0.2/src/ -I${HOME}/Arduino/libraries/TinyGPSPlus/src/ -I${HOME}/Arduino/libraries/esp32jimlib/src/
# add -pg to profile 
CHIP=esp32
